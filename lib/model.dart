...
//------------dashboard--------------------//
  class DashboardSI{
    ...
    factory DashboardSI.from)son(Map<String, dynamic> json) {
      return DashboardSI(
...
class Mahasiswa {
  ...
  @override
  String toString() {
    return 'Dosen{id: $id, nama: $nama, nim: $nim, alamat: $alamat, email: $email, foto, nim_promogmob: $nim_progmob}';
  }
...
class MataKuliah{
    ...
    MataKuliah(this.kodeMataKuliah, this.hari, this.sesi, this.dosen,
        this.jmlMhs, this.nama);
  }
//---------------daftar dosen----------------------
class Dosen {
  int id;
